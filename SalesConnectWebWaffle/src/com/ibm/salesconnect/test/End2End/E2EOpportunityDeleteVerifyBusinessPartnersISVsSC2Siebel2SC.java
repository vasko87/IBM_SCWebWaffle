...
public class E2EOpportunityDeleteVerifyBusinessPartnersISVsSC2Siebel2SC extends ProductBaseTest {

	Logger log = LoggerFactory.getLogger(E2EOpportunityDeleteVerifyBusinessPartnersISVsSC2Siebel2SC.class);
	...
	public void Test_E2EOpportunityCreateVerifyPartnersTabOpportunityTeamRoleWithSetTeamRolesSC2Siebel(){
		...
		try {
			...
			oppt.sOpptDesc = "E2E (Opportunity - Delete) Verify Business Partners/ISVs SC <<  >> Siebel - AG " + GC.sUniqueNum;
		...
		try {
			...
			oppt.sOpptDesc = "E2E (Opportunity - Delete) Verify Business Partners/ISVs SC <<  >> Siebel - AP " + GC.sUniqueNum;			
		...
		try {
			...
			oppt.sOpptDesc = "E2E (Opportunity - Delete) Verify Business Partners/ISVs SC <<  >> Siebel - EU " + GC.sUniqueNum;
		...
		log.info("End of test method E2EOpportunityDeleteVerifyBusinessPartnersISVsSC2Siebel2SC");
