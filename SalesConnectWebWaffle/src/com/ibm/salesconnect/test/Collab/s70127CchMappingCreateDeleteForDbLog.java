...
public class s70127CchMappingCreateDeleteForDbLog  extends ProductBaseTest {
	Logger log = LoggerFactory.getLogger(s70127CchMappingCreateDeleteForDbLog.class);
	...
	public void Test_s70127CchMappingCreateDeleteForDbLogs() {
		...
		log.info("Start of test method Test_s70127CchMappingCreateDeleteForDbLog()");
		try {
			...
			log.info("End of test method Test_s70127CchMappingCreateDeleteForDbLog()");
		}
	}		
