 ...
 */
public class s30351UserRemovedFromClientNoAccessToCommunity extends
		ProductBaseTest {
	Logger log = LoggerFactory.getLogger(s30351UserRemovedFromClientNoAccessToCommunity.class);

	@Test(groups = {"Membership"})
	public void Test_s30351UserRemovedFromClientNoAccessToCommunity() throws SQLException, InterruptedException {
		log.info("Start of test setup for s30351UserRemovedFromClientNoAccessToCommunity");
		...
		log.info("End of test method s30351UserRemovedFromClientNoAccessToCommunity");
	}
}